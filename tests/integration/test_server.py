...
async def test_handle_graph_tool(mock_graph_service):
    ...
    mock_graph_service.execute_command = AsyncMock(
    ...
    mock_graph_service.execute_command.assert_called_with("me", "GET", None)
...
async def test_handle_unknown_tool():
    ...
    result = await process_tool_call("unknown_tool", {}, None, None)
